...
class MyFrame1 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		sbSizer4 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"Result" ), wx.HORIZONTAL )

		bSizer2 = wx.BoxSizer( wx.HORIZONTAL )

		self.m_bitmap1 = wx.StaticBitmap( sbSizer4.GetStaticBox(), wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size( 80,150 ), 0 )
		self.m_bitmap1.SetMinSize( wx.Size( 80,150 ) )
		self.m_bitmap1.SetMaxSize( wx.Size( 80,150 ) )

		bSizer2.Add( self.m_bitmap1, 0, wx.ALL, 5 )

		self.m_gauge2 = wx.Gauge( sbSizer4.GetStaticBox(), wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_SMOOTH|wx.GA_VERTICAL )
		...
		self.m_bitmap2 = wx.StaticBitmap( sbSizer4.GetStaticBox(), wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size( 80,150 ), 0 )
		self.m_bitmap2.SetMinSize( wx.Size( 80,150 ) )
		self.m_bitmap2.SetMaxSize( wx.Size( 80,150 ) )

		bSizer3.Add( self.m_bitmap2, 0, wx.ALL, 5 )

		self.m_gauge3 = wx.Gauge( sbSizer4.GetStaticBox(), wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_SMOOTH|wx.GA_VERTICAL )
		...
		self.m_bitmap3 = wx.StaticBitmap( sbSizer4.GetStaticBox(), wx.ID_ANY, wx.NullBitmap, wx.DefaultPosition, wx.Size( 80,150 ), 0 )
		self.m_bitmap3.SetMinSize( wx.Size( 80,150 ) )
		self.m_bitmap3.SetMaxSize( wx.Size( 80,150 ) )

		bSizer4.Add( self.m_bitmap3, 0, wx.ALL, 5 )

		self.m_gauge4 = wx.Gauge( sbSizer4.GetStaticBox(), wx.ID_ANY, 100, wx.DefaultPosition, wx.DefaultSize, wx.GA_SMOOTH|wx.GA_VERTICAL )
